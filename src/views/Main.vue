    ...
    <div class="section flex flex-col">
      <div class="flex justify-between my-1">
        ...
        <div class="w-3/5 self-center">
          ...
          <div class="font_1 text-lg">{{ weeklyHKUST.overall }}% complete</div>
        </div>
      </div>
      <div class="flex justify-between my-1">
        <div class="ring-chart">
    ...
    >
      <div class="flex items-center">
        ...
        <div class="m-4">
          ...
          <div class="font_3">{{ item.date }}</div>
        </div>
      </div>
      <div class="ring-chart">
...
const mealList = [
  {
    meal_id: 1,
    date: "2023-02-01 17:00:23",
    overall: 87,
    vegetable: 75,
    meat: 45,
    rice: 77,
    pic:
      "https://codefun-proj-user-res-1256085488.cos.ap-guangzhou.myqcloud.com/63b6ffdc5a7e3f0310ed5cbb/63b7001e5c976b00115e5363/16729375932517574218.png",
  },
  {
    meal_id: 3,
    date: "2023-02-01 17:00:23",
